                                     ...
                                     <div class="row">
                                         ...
                                         <div class="form-group col-md-6" style="margin-bottom:0px;">
                                             ...
                                             <input type="text" name="marital_status"
                                                 value="{{ old('marital_status') }}" class="form-control"
                                         ...
                                         <div class="form-group col-md-6">
                                             ...
                                             <textarea name="address" style="display: inline-block" class="form-control" required>{{ old('address') }}</textarea>
                                             <div style="color: red;">
                                                 {{ $errors->first('address') }}</div>
                                         </div>
                                         <div class="form-group col-md-6">
                                             <label> Permanent Address <span style="color: red">*</span> </label>
                                             <textarea name="permanent_address" style="display: inline-block" class="form-control" required>{{ old('permanent_address') }}</textarea>
                                             <div style="color: red;">
                                         ...
                                         <div class="form-group col-md-6">
                                             ...
                                             <textarea name="qualification" class="form-control" style="display: inline-block" required>{{ old('qualification') }}</textarea>
                                             <div style="color: red;">
